      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-lg font-semibold">FreelanceHub</h3>
            <p className="text-gray-400 text-sm">
              Find the perfect freelancer for your project or find your next opportunity.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <Link to="/create-profile" className="text-base text-gray-300 hover:text-white">
                  Create Profile
                </Link>
              </li>
              <li>
                <Link to="/find-jobs" className="text-base text-gray-300 hover:text-white">
                  Find Jobs
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                <Link to="/hire" className="text-base text-gray-300 hover:text-white">
                  How to Hire
                </Link>
              </li>
              <li>
                <Link to="/talent" className="text-base text-gray-300 hover:text-white">
                  Find Talent
                </Link>
              </li>
              <li>
