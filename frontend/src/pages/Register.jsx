    ...
    try {
      ...
      if (response.success) {
        if (response.data.requires_verification) {
          ...
          // Fallback for direct login if verification disabled (unlikely)
              ...
              <div className="flex justify-between items-center relative">
                ...
                {[1, 2, 3].map((num) => (
                  <div key={num} className="relative z-10">
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-500 ease-in-out transform ${step >= num
                    ...
                    <div>
                      ...
                      <div className="mt-1">
                        <input
                          ...
                          className={`appearance-none block w-full px-3 py-2 border ${errors.name ? 'border-red-500' : 'border-gray-700'
                    ...
                    <div>
                      ...
                      <div className="mt-1">
                        <input
                          ...
                          onChange={handleChange}
                          className={`appearance-none block w-full px-3 py-2 border ${errors.email ? 'border-red-500' : 'border-gray-700'
                            } rounded-lg bg-gray-800/50 text-gray-300 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all duration-200`}
                    ...
                    <div>
                      ...
                      <div className="mt-1 relative">
                        <input
                          ...
                          onChange={handleChange}
                          className={`appearance-none block w-full px-3 py-2 border ${errors.password ? 'border-red-500' : 'border-gray-700'
                            } rounded-lg bg-gray-800/50 text-gray-300 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all duration-200 pr-10`}
                          placeholder="••••••••"
                        />
                        <button
                          type="button"
                    ...
                    <div>
                      ...
                      <div className="mt-1 relative">
                        <input
                          ...
                          onChange={handleChange}
                          className={`appearance-none block w-full px-3 py-2 border ${formData.password && formData.password_confirmation
                              ? formData.password === formData.password_confirmation
                                ? 'border-green-500' // green if matching
                                : 'border-red-500'   // red if mismatch
                              : 'border-gray-700'    // default gray
                            } rounded-lg bg-gray-800/50 text-gray-300 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all duration-200`}
                          placeholder="••••••••"
                        />
                      </div>
                  ...
                  <>
                    <div>
                      ...
                      <div className="space-y-4">
                        <label
                          className={`flex items-center p-4 border rounded-lg cursor-pointer transition-all duration-200 ${formData.role === 'freelancer'
                        ...
                        >
                          ...
                          <div className={`w-5 h-5 border-2 rounded-full flex items-center justify-center ${formData.role === 'freelancer' ? 'border-yellow-500' : 'border-gray-700'
                            }`}>
                        ...
                        <label
                          className={`flex items-center p-4 border rounded-lg cursor-pointer transition-all duration-200 ${formData.role === 'client'
                            ? 'border-yellow-500 bg-yellow-500/10'
                            : 'border-gray-700 hover:bg-gray-800/50'
                            }`}
                        >
                          ...
                          <div className={`w-5 h-5 border-2 rounded-full flex items-center justify-center ${formData.role === 'client' ? 'border-yellow-500' : 'border-gray-700'
                            }`}>
